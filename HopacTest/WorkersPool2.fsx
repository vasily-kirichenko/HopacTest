...
type Pool<'msg, 'res>(degreeOfParallelism: int, source: Alt<'msg>, worker: 'msg -> Choice<'res, 'msg * exn>) =
...
module Test =
    let mb = mb<int>()
    let pool = Pool<int, unit>(3, mb, (fun msg -> printfn "[worker] Received %A" msg; Choice1Of2()))
